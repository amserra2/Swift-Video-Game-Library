...
public func createDirectories() {
    let files = url.appendingPathComponent("Files").path
    let images = url.appendingPathComponent("Images").path
    let gameImages = "\(images)/Games"
    let platformImages = "\(images)/Platforms"
