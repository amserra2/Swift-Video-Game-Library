...
public let files = url.appendingPathComponent("Files").path
public let images = url.appendingPathComponent("Images").path
public let gameImages = "\(images)/Games"
public let platformImages = "\(images)/Platforms"
